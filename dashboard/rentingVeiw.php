...
include('../include/connection.php');
 if (isset($_SESSION["user_id"])) {
   $id= $_SESSION["user_id"];
    ...
    $result = mysqli_query($conn,"select * from property ORDER BY Property_id DESC");
       ...
       <?php do { ?>
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <br>
                <a class="btn btn-primary" href="rentingVeiwregistration.php?id=<?php echo $row["Property_id"]; ?>">
                Rent this</i></a>
            </div>
        </div>
       <hr>
